...
- **THEN** the renderer finds the required shaders, fixed prototype textures, and packaged static GLB and starts normally
...
- **WHEN** a required shader, fixed prototype texture, or static GLB is absent beneath the configured resource root
