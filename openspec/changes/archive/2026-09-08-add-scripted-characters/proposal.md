...
- Keep authored/visible feet anchored to accepted ground on slopes, with a
  support-derived capsule offset shared by clearance validation and collision.
- Synchronize walking phase/footsteps with accepted travel and fire one
  ...
  cue contention, suspension and fresh-run behavior. The interaction cue lasts
  one second, with at most 0.25 seconds of audible effect followed by silence
  and a one-second Russian caption.
...
[P07a](../2026-09-08-add-character-animation/proposal.md) is implemented
